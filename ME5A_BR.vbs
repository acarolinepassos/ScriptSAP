...
'============================ Extracao SAP =========================================
	...
	Sub ExecuteScript
		...
		session.findById("wnd[1]/usr/ctxtDY_FILENAME").text = "ME5A_BR.txt"
		...
		session.findById("wnd[1]/tbar[0]/btn[0]").press
		session.findById("wnd[1]/usr/ctxtDY_PATH").text = "C:\Temp\RCSPOT\"
		session.findById("wnd[1]/usr/ctxtDY_FILENAME").text = "ME5A_BR_CRI.txt"
		...
		session.findById("wnd[1]/tbar[0]/btn[0]").press
		session.findById("wnd[1]/usr/ctxtDY_PATH").text = "C:\Temp\RCSPOT\"
		session.findById("wnd[1]/usr/ctxtDY_FILENAME").text = "ME5A_BR_AOG.txt"
		session.findById("wnd[1]/usr/ctxtDY_FILENAME").caretPosition = 15
		session.findById("wnd[1]/tbar[0]/btn[11]").press
		session.findById("wnd[0]/tbar[0]/btn[3]").press
		session.findById("wnd[0]/tbar[0]/btn[3]").press
